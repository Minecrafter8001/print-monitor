...
- **Entry points**: Server in [server.js](../server.js), client composition in [public/app.js](../public/app.js), browser modules in [public/modules](../public/modules), Moonraker JSON-RPC in [modules/moonraker-client.js](../modules/moonraker-client.js), and status normalization in [modules/moonraker-status.js](../modules/moonraker-status.js).
...
- **User/IP tracking**: [modules/ip-utils.js](../modules/ip-utils.js) resolves client IPs. [modules/user-stats.js](../modules/user-stats.js) tracks browser and camera clients. Admin-only features must retain the local-IP policy.
